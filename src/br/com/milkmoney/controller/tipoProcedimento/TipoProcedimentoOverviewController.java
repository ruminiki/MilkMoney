...
@Controller
public class TipoProcedimentoOverviewController extends AbstractOverviewController<Integer, TipoProcedimento> {
	...
	public String getFormName() {
		return "view/tipoProcedimento/TipoProcedimentoOverview.fxml";
	}
