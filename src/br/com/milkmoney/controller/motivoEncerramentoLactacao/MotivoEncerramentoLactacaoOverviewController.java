...
@Controller
public class MotivoEncerramentoLactacaoOverviewController extends AbstractOverviewController<Integer, MotivoEncerramentoLactacao> {
	...
	public String getFormName() {
		return "view/motivoEncerramentoLactacao/MotivoEncerramentoLactacaoOverview.fxml";
	}
