...
import br.com.milksys.controller.animal.AnimalFormController;
...
public class PartoFormController extends AbstractFormController<Integer, Parto> {
	...
	public void initialize() {
		...
		if ( getState().equals(State.INSERT) || getState().equals(State.UPDATE) || 
				getState().equals(State.INSERT_TO_SELECT) || getState().equals(State.CREATE_TO_SELECT) ){
	...
	@FXML
	protected void handleCadastrarCria() {
		
		animalFormController.setState(State.CREATE_TO_SELECT);
		animalFormController.setObject(new Animal());
		animalFormController.showForm();
		
		if ( animalFormController.getObject() != null ){
			getObject().getCrias().add( animalFormController.getObject() );
			table.getItems().add(animalFormController.getObject());
		}
