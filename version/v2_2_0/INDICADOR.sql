...
INSERT INTO milkmoney.indicador (id,menorValorIdeal,maiorValorIdeal,descricao,classeCalculo,ordem,sigla,definicao,tipo,formato,sufixo,objetivo)VALUES
(5,35,50,'TAXA DE PRENHEZ (%)','br.com.milkmoney.service.indicadores.TaxaPrenhes',5,'TP','Mede o percentual de animais que ficam gestantes a cada 21 dias em relação ao número total de vacas que estavam disponíveis para enseminar no mesmo período. Vale lembrar que mesmo com uma Taxa de Concepção alta a Taxa de Prenhes (TP) pode ser baixa, pois a Taxa de Concepção (TC) se refere apenas aos animais inseminados no período, enquanto que a Taxa de Prenhez (TP) se refere a todos os animais que estavam disponíveis para serem inseminados. Por isso no geral ela é mais importante. Os valores ideias giram em torno de 25 a 35%.','Z','DECIMAL UMA CASA','%','DENTRO OU ACIMA DO INTERVALO IDEAL');

INSERT INTO milkmoney.indicador (id,menorValorIdeal,maiorValorIdeal,descricao,classeCalculo,ordem,sigla,definicao,tipo,formato,sufixo,objetivo)VALUES
(6,50,60,'% DE VACAS PRENHAS','br.com.milkmoney.service.indicadores.PercentualVacasPrenhas',6,'VPR','Nesse indicador é registrado o percentual de vacas prenhas em relaçao ao total de animais do rebanho.','Z','NÚMERO INTEIRO','%','DENTRO OU ACIMA DO INTERVALO IDEAL');

INSERT INTO milkmoney.indicador (id,menorValorIdeal,maiorValorIdeal,descricao,classeCalculo,ordem,sigla,definicao,tipo,formato,sufixo,objetivo)VALUES
(7,60,115,'PRIMEIRO SERVIÇO APÓS O PARTO','br.com.milkmoney.service.indicadores.PrimeiroServicoAposParto',7,'PSPP','O número de dias pós-parto no primeiro serviço é influenciado pelo período voluntário de espera (PVE). É o cálculo do número de dias do parto até o primeiro serviço para as vacas inseminadas. Para um intervalo entre partos de 12 meses esse período deve ser no máximo de 85 dias.','Z','NÚMERO INTEIRO','d','DENTRO OU ABAIXO DO INTERVALO IDEAL');

INSERT INTO milkmoney.indicador (id,menorValorIdeal,maiorValorIdeal,descricao,classeCalculo,ordem,sigla,definicao,tipo,formato,sufixo,objetivo)VALUES
(8,1.0,1.7,'NÚMERO DE SERVIÇOS POR CONCEPÇÃO','br.com.milkmoney.service.indicadores.NumeroServicosPorConcepcao',8,'NSPC','Número de serviços necessários até que se atinja a concepção. Cada repetição de cio necessitará de um novo serviço. No geral esse indicador se refere a quantidade de coberturas e inseminações que são necessárias até que o animal fique gestante. Como cada enseminação tem um intervalo de pelo menos 21 dias, significa que a cada repetição o animal tende a ampliar em 21 dias pelo menos, o seu intervalo entre partos.','Z','DECIMAL UMA CASA','','DENTRO OU ABAIXO DO INTERVALO IDEAL');

INSERT INTO milkmoney.indicador (id,menorValorIdeal,maiorValorIdeal,descricao,classeCalculo,ordem,sigla,definicao,tipo,formato,sufixo,objetivo)VALUES
(9,100,200,'DIAS EM LACTAÇÃO','br.com.milkmoney.service.indicadores.DiasEmLactacao',9,'DEL','Nesse indicador é registrado a média de dias pós parto das vacas em lactação. Uma média entre 100 e 200 dias indica a maioria dos animais no pico da produção na lactação.','Z','NÚMERO INTEIRO','d','DENTRO DO INTERVALO IDEAL');

INSERT INTO milkmoney.indicador (id,menorValorIdeal,maiorValorIdeal,descricao,classeCalculo,ordem,sigla,definicao,tipo,formato,sufixo,objetivo)VALUES
(10,15,20,'VACAS SECAS x VACAS EM LACTAÇÃO','br.com.milkmoney.service.indicadores.RelacaoVacasSecasXVacasLactacao',10,'VSVL','A relação vacas secas/lactação mede a eficiência reprodutiva do rebanho e determina lucro ou prejuízo, sendo o desequilíbrio dessa relação uma das causas de maiores prejuízos na atividade leiteira. ','Z','DECIMAL UMA CASA','%', 'DENTRO OU ABAIXO DO INTERVALO IDEAL');